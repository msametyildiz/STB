<div class="content-wrapper">
    ...
    <div class="content-header" style="padding-top: 3%;">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 ">
                    <h3 class="m-0 text-dark">Gerçekleşen Eğitim Bilgileri </h3>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                    ...
                    <div ><a href=""  ><img src="stbpdf.jpg" alt="" style="width: 100%;"></a>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;" colspan="4">Yapılan Eğitim Programının</th>
                                <th style="text-align: center;" colspan="3">Eğitime Katılan Personelin</th>
                            </tr>
                            <tr>
                                <th>Sıra</th>
